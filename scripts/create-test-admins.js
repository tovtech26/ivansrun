...
const accounts = [
  {
    email: "admin.test@ivansrun.africa",
    passwordEnv: "IVANSRUN_TEST_ADMIN_PASSWORD",
    full_name: "Admin Test",
    company_name: "Ivansrun Africa",
    role: "admin",
  },
  {
    email: "ops.admin@ivansrun.africa",
    passwordEnv: "IVANSRUN_TEST_OPS_PASSWORD",
    full_name: "Ops Admin",
    company_name: "Ivansrun Africa",
    role: "admin",
  },
  {
    email: "reseller.test@ivansrun.africa",
    passwordEnv: "IVANSRUN_TEST_RESELLER_PASSWORD",
    full_name: "Reseller Test",
    company_name: "Test Reseller Co",
    role: "reseller",
  },
  {
    email: "pending.test@ivansrun.africa",
    passwordEnv: "IVANSRUN_TEST_PENDING_PASSWORD",
