...
assert.deepEqual(backTargetForRoute("ambassador"), { route: "store" });
...
assert.equal(buildRouteUrl("ambassador", { ambassadorSlug: "mpho-kgatlana" }), "#/ambassador/mpho-kgatlana");
...
assert.deepEqual(parseRouteUrl("#/ambassador/mpho-kgatlana"), { route: "ambassador", productId: null, orderId: null, storySlug: null, ambassadorSlug: "mpho-kgatlana" });
